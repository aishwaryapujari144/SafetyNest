...
import static android.Manifest.permission.CALL_PHONE; import static android.Manifest.permission.SEND_SMS;
...
public class MainActivity2 extends AppCompatActivity {
    ...
    private void call() {
        ...
        i.setData(Uri.parse("tel:9515186383"));
    ...
    private void startTrack() {
        if(ActivityCompat.checkSelfPermission(MainActivity2.this, Manifest.permission.ACCESS_FINE_LOCATION)
            ...
            if(locationGPS!=null){
                double lat=locationGPS.getLatitude(); double lon=locationGPS.getAltitude(); x=String.valueOf(lat);
    ...
    private void onGPS() {
        final AlertDialog.Builder builder=new AlertDialog.Builder(this); builder.setMessage("Enadle GPS").setCancelable(false).setPositiveButton("yes", new
                DialogInterface.OnClickListener() { @Override
                public void onClick(DialogInterface dialog, int which) {
                    startActivity(new Intent(Settings.ACTION_LOCATION_SOURCE_SETTINGS));

                }
                }).setPositiveButton("NO", new DialogInterface.OnClickListener() { @Override
